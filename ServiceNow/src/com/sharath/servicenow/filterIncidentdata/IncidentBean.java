...
public class IncidentBean extends Object {
	...
	public String toString() {
		return "IncidentBean [incidentNumber=" + incidentNumber + ", incidentReportedUser=" + incidentReportedUser
				+ ", contactNumber=" + contactNumber + ", applicationImpacted=" + applicationImpacted
				+ ", incidentStatus=" + incidentStatus + ", shortDesciption=" + shortDesciption + ", incidentPriority="
				+ incidentPriority + "]";
	}
